// Forked and modified from https://github.com/getsentry/sentry-javascript-bundler-plugins/blob/fd2a99c4ffb79974db1830ab59cd59a32433f60c/packages/bundler-plugin-core/src/debug-id-upload.ts.
